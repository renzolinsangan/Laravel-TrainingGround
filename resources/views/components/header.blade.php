...
<header class="bg-blue-900 text-white p-4">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="hidden md:flex items-center space-x-4">
            <x-nav-link url="/" :active="request()->is('/')">Home</x-nav-link> {{-- putting : will set it into boolean, not string --}}
            ...
            <x-button-link url="/jobs/create" icon="edit">Create Job</x-button-link> {{-- IF IT HAS DEFAULT VALUE, NO NEED TO CALL IT IN THE COMPONENT --}}
        </nav>
        <button
            id="hamburger"
